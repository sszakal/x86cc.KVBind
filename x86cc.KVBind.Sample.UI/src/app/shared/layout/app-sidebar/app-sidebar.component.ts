...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 3.25C6.00736 3.25 5 4.25736 5 5.5V18.5C5 19.7426 6.00736 20.75 7.25 20.75H16.75C17.9926 20.75 19 19.7426 19 18.5V8.62132C19 8.02458 18.7629 7.45228 18.341 7.03033L15.2197 3.90901C14.7977 3.48705 14.2254 3.25 13.6287 3.25H7.25ZM6.5 5.5C6.5 5.08579 6.83579 4.75 7.25 4.75H13.25V7.5C13.25 8.74264 14.2574 9.75 15.5 9.75H17.5V18.5C17.5 18.9142 17.1642 19.25 16.75 19.25H7.25C6.83579 19.25 6.5 18.9142 6.5 18.5V5.5ZM14.75 5.06066L17.1893 8.25H15.5C15.0858 8.25 14.75 7.91421 14.75 7.5V5.06066ZM8.75 12C8.75 11.5858 9.08579 11.25 9.5 11.25H14.5C14.9142 11.25 15.25 11.5858 15.25 12C15.25 12.4142 14.9142 12.75 14.5 12.75H9.5C9.08579 12.75 8.75 12.4142 8.75 12ZM8.75 15.5C8.75 15.0858 9.08579 14.75 9.5 14.75H14.5C14.9142 14.75 15.25 15.0858 15.25 15.5C15.25 15.9142 14.9142 16.25 14.5 16.25H9.5C9.08579 16.25 8.75 15.9142 8.75 15.5Z" fill="currentColor"/></svg>`,
